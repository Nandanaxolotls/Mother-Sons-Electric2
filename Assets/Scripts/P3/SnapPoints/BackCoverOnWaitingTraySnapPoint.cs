...
public class BackCoverOnWaitingTraySnapPoint : MonoBehaviour
{
    ...
    public event System.Action BackCoverOnWaitingSnapped;
    private void Awake()
    {
    ...
    private void SnapObject()
    {
        ...
        if (objectToActivateAfterSnap != null)
        {
            ...
            BackCoverOnWaitingSnapped?.Invoke(); // Notify StepManager
