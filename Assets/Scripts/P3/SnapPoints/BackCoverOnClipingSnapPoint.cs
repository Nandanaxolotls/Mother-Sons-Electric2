...
public class BackCoverOnClipingSnapPoint : MonoBehaviour
{
    ...
    public event System.Action BackCoverSnappedToClipping;
    private void Awake()
    {
    ...
    private void SnapObject()
    {
        ...
        if (objectToActivateAfterSnap != null)
        {
            ...
            BackCoverSnappedToClipping?.Invoke(); // Notify StepManager
