...
public class BackCoverOnPunchingSnapPoint : MonoBehaviour
{
    ...
    public event System.Action BackSnappedOnPunching;
    private void Awake()
    {
    ...
    private void SnapObject()
    {
        ...
        if (objectToActivateAfterSnap != null)
        {
            ...
            BackSnappedOnPunching?.Invoke(); // Notify StepManager
