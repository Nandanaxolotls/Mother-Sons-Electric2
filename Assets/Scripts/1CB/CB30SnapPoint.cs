...
public class CB30Snapping : MonoBehaviour
{
    ...
    public GameObject objectToDeactivateAfterSnap;
    ...
    public event System.Action CB30snapped;
    private void Awake()
    {
    ...
    private void SnapObject()
    {
        ...
        if (objectToActivateAfterSnap != null)
        {
            ...
            CB30snapped?.Invoke(); // Notify StepManager
                                        // ? Find and start the sequential snap process

        }
        if(objectToDeactivateAfterSnap != null)
        {
            objectToDeactivateAfterSnap.SetActive(false);
        }
