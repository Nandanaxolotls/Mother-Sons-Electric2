...
public class RemoteKeyOnTableSnapPoint : MonoBehaviour
{
    ...
    public event System.Action RemoteKeySnappedToTable;
    private void Awake()
    {
    ...
    private void SnapObject()
    {
        ...
        if (objectToActivateAfterSnap != null)
        {
            ...
            RemoteKeySnappedToTable?.Invoke(); // Notify StepManager
