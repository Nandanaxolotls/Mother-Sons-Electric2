...
public class CoverToBlackBox2 : MonoBehaviour
{
    ...
    public event System.Action GoodCoversnappedToBlackBox2;
    private void Awake()
    {
    ...
    private void SnapObject()
    {
        ...
        if (objectToActivateAfterSnap != null)
        {
            ...
            GoodCoversnappedToBlackBox2?.Invoke(); // Notify StepManager
