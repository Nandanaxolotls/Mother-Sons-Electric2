...
public class Door2 : MonoBehaviour
{
    ...
    public event System.Action Door2ReachedOriginal;
    public event System.Action Door2ReachedDesired;
    ...
    private IEnumerator SmoothRotate(Vector3 targetRotation, bool goingToDesired)
    {
        ...
        if (goingToDesired)
        {
            ...
            Door2ReachedDesired?.Invoke();
            isLocked = true;  // Lock when desired position is reached
        }
        else
        {
            Door2ReachedOriginal?.Invoke();
        }
    }
