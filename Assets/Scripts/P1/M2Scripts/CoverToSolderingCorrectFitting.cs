...
public class CoverToSolderingCorrectFitting : MonoBehaviour
{
    ...
    public event System.Action CorrectPlacedCoversnappedToSoldering;
    private void Awake()
    {
    ...
    private void SnapObject()
    {
        ...
        if (objectToActivateAfterSnap != null)
        {
            ...
            CorrectPlacedCoversnappedToSoldering?.Invoke(); // Notify StepManager
