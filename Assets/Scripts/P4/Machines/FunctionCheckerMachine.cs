...
public class FunctionCheckerMachine : MonoBehaviour
{
    [Header("References")]
    ...
    public event System.Action FunctionCheckingDone;
    ...
    private IEnumerator ProcessSequence()
    {
        ...
        // Step 2: Wait while object2 is in place
        yield return new WaitForSeconds(13f);

      
        // Step 3: Then move object1 back
