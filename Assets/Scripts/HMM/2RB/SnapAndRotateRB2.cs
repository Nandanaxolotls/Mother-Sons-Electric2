...
public class SnapAndRotateRB2 : MonoBehaviour
{
    ...
    public event System.Action RB2done;
    private void Start()
    {
    ...
    {
        int[] sliderValues = { 00, 50, 45, 43, 00, 00 };
        int[] upperTextValues = { 13, 23, 33, 43, 53, 0 };
        string[] lowerTextValues = { "00.000", "00.067", "00.070", "00.040", "00.000", "00.000" };
    ...
    private IEnumerator GreenButtonSequence()
    {
        ...
        // Rotate the snapped object 90 degrees on Y axis
