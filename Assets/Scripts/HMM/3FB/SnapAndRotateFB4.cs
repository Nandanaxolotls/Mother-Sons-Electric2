...
public class SnapAndRotateFB4 : MonoBehaviour
{
    ...
    public GameObject SphereFour;
    public bool DoneTutorial = false;

    public event System.Action SnappedToJig4;
    public event System.Action PressBlueButton;
    public event System.Action FB4done;
    ...
    private IEnumerator SnapAndRotate(GameObject obj, XRGrabInteractable grab)
    {
        ...
        Point4GreenButton.SetActive(true);
        Point4BlueButton.SetActive(true);
        // Point5GreenButton.SetActive(false);
        if (SphereFour != null && Istutorial && !DoneTutorial)
        {
        ...
        {
            SnappedToJig4?.Invoke();
        }
    }

    private void UpdateUIValues()
    {
        int[] sliderValues = { 0, 0, 0, 0 , 75 };
        int[] upperTextValues = { 15, 25, 35, 45, 55 };
        string[] lowerTextValues = { "00.000", "00.0000", "00.000", "00.000", "00.041" };
    ...
    {
        int[] newUpperValues = { 11, 21, 31, 41, 51 };
