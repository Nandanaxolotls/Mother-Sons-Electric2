...
public class SnapAndRotateFB : MonoBehaviour
{
    ...
    public event System.Action SnappedToJig1;
    public event System.Action PressBlueButton;
    public event System.Action FB1done;

    private void Start()
    {
        statusText.SetActive(false);
        if (SphereOne != null && Istutorial && !DoneTutorial)
        { 
    ...
    private IEnumerator SnapAndRotate(GameObject obj, XRGrabInteractable grab)
    {
        ...
        Point1GreenButton.SetActive(true);
        Point1BlueButton.SetActive(true);
        ...
        {
            SnappedToJig1?.Invoke();
        }
    }

    private void UpdateUIValues()
    {
        int[] sliderValues = { 50, 60, 100, 100, 70 };
        int[] upperTextValues = { 11, 21, 31, 41, 51 };
        string[] lowerTextValues = { "16.0166", "16.0177", "00.002", "00.003", "00.004" };
    ...
    {
        int[] newUpperValues = { 13, 23, 33, 43, 53 };
