...
public class SnapAndRotateRB : MonoBehaviour
{
    ...
    public event System.Action RB1done;
    private void Start()
    {
    ...
    {
        int[] sliderValues = { 55, 45, 53, 53, 50, 30 };
        int[] upperTextValues = { 14, 24, 34, 44, 54, 30 };
        string[] lowerTextValues = { "12.0133", "12.0121", "00.002", "00.003", "00.003", "00.003" };
    ...
    {
        int[] newUpperValues = { 13, 23, 33, 43, 53, 0 };
